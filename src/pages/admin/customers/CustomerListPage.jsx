          ...
          <div className="min-h-screen bg-gray-50 font-body">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 font-display">Customers</h1>
                  <p className="text-[13.5px] text-gray-500 mt-1">Manage customer profiles before booking a tour.</p>
                </div>
                <button
                  onClick={onCreate}
